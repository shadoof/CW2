...
public:
    ...
    */
    TextureRef loadTexture(
		...
		G3D::WrapMode           wrap = G3D::WrapMode::TILE,  
	...
	friend struct HashTrait<G3D::TextureManager::TextureArgs>;
};
...
template <>
struct HashTrait<G3D::TextureManager::TextureArgs> {
	static size_t hashCode(G3D::TextureManager::TextureArgs key) { return key.hashCode(); }
};
